...
// reference image). viewBox is 200x220 — must match FRAME_DEFS.orange's
// width/height in lib/frames.ts. The face-hole is the circle cx=100 cy=132
// r=64, cut via fill-rule="evenodd" — its bounding box (36,68,128,128) must
// match FRAME_DEFS.orange.hole (18%, 30.91%, 64%, 58.18%) if this shape is
// ever redrawn.
export function Orange({ style }: { style?: React.CSSProperties }) {
  return (
    <svg viewBox="0 0 200 220" style={style} xmlns="http://www.w3.org/2000/svg">
      ...
      {/* peel-texture dots, kept clear of the hole (r=64 about cx100 cy132) */}
      {[
