// Mirrors storefront/src/components/frames/Watermelon.tsx — kept as a
// second hand-copy since admin/ and storefront/ don't share a package.
// Keep the two in sync if the art or hole geometry ever changes.
